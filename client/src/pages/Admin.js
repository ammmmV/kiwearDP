...
const Admin = () => {
    ...
    return (
        <Container style={{display: "flex", flexDirection: "column"}}>
                        ...
                        {types?.map((type, index) => (
                            <tr key={type.id} className='userLine'>
                                ...
                                <td className="btn-remove">
                                    <button className="hover-image-btn hidden" onClick={() => handleRemoveType(type.id)}>
                    ...
                    <tbody>
                        {fabrics?.map((fabric, index) => (
                            <tr key={fabric.id} className='userLine'>
                                ...
                                <td>{fabric.name}</td>
                                <td className="btn-remove">
                                    <button className="hover-image-btn hidden" onClick={() => handleRemoveFabric(fabric.id)}>
                                        <img src={minus} height={25} alt="Remove" />
                                    </button>
                                </td>
                            </tr>
            ...
            <CreateFabric show={fabricVisible} onHide={() => {
